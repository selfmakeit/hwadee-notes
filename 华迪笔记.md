...
![image-20220303173832686](华迪笔记.assets/image-20220303173832686.png)

***

3. 在done后面的方法体内写入 e=r.done(e)，实现在layui处理之前重制返回信息。
...
```vue
<u-waterfall v-model="policyData" ref="uWaterfall" add-time="100">
			<template v-slot:left="{leftList}">
				<view class="demo-warter" v-for="(item, index) in leftList" :key="index">
					<view  @click="viewInfo(item.id)">				
		...
		<view class="LoadingMore">
			<u-loadmore  :status="loadStatus" @loadmore="queryPolicyData"></u-loadmore>
		</view>
```
...
###(NOT IN)
SELECT * from C_PURCHASINGMASTERDATA where NOT FIND_IN_SET(EKGRP,'C54,C02,C14,C60,C06,C61,C53,C51,C12,C08,C03,C07')
